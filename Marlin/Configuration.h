...
#define STRING_CONFIG_H_AUTHOR "(crx-cooper, default config)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  55.52 // A20M autotuned 60 cycles with fan @ 80%
    #define DEFAULT_Ki  10.59
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 88.35  // A20M with superplate
  #define DEFAULT_bedKi 17.13  // A20M with superplate
  #define DEFAULT_bedKd 303.82 // A20M with superplate
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 300, 300, 30, 100 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 800, 300, 25, 500 }

//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 1000, 1000, 50, 1000 } // these cannot be exceeded - use to protect hardware
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, 0, -1.11 }
 ...
 */
#define Z_PROBE_END_SCRIPT "G0 X0 F3000"
...
#define HOMING_FEEDRATE_XY 1850 //was (50*60)
#define HOMING_FEEDRATE_Z  180  // was (4*60)
